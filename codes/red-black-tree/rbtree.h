...
extern void rb_replace_node(struct rb_node* victim, struct rb_node* node,
	struct rb_root* root);
extern void rb_replace_node_rcu(struct rb_node* victim, struct rb_node* node,
	struct rb_root* root);
	...
	struct rb_root_cached* root)
{
	if (root->rb_leftmost == victim)
		root->rb_leftmost = node;
	rb_replace_node(victim, node, &root->rb_root);
}
