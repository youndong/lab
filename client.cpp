...
// class PropertiesChanged_Proxy
// : public ::DBus::InterfaceProxy
// {
// public:

//     PropertiesChanged_Proxy()
//     : ::DBus::InterfaceProxy("org.freedesktop.DBus.Properties")
//     {
//         connect_signal(PropertiesChanged_Proxy, PropertiesChanged, _PropertiesChanged_stub);
//     }
...
// 	public PropertiesChanged_Proxy,
// 	public DBus::IntrospectableProxy,
// 	public DBus::ObjectProxy
// {
// public:
// 	PropertiesChangedHandler(DBus::Connection& conn, const char* path, const char* name);
...
// PropertiesChangedHandler::PropertiesChangedHandler(DBus::Connection& conn, const char* path, const char* name)
// 	: DBus::ObjectProxy(conn, path, name)
// {
// }

// void PropertiesChangedHandler::PropertiesChanged(const std::string& interface, 
//         const std::map<std::string, DBus::Variant>& changed_properties, 
//         const std::vector<std::string>& invalidated_properties)
// {
